...
typedef ExecuteUnary<X> = void Function(StoreManager, X);

/// Type of a function that works with store by [StoreManager].
///
/// Accepts an additional arguments.
typedef ExecuteBinary<X, Y> = void Function(StoreManager, X, Y);
...
typedef Write<A> = dynamic Function(A);

/// Type of a function that writes data to a complex object.
///
/// Accepts an additional argument to influence the writing.
typedef WriteUnary<A, X> = dynamic Function(A, X);

/// Type of a function that writes data to a complex object.
///
/// Accepts an additional arguments to influence the writing.
typedef WriteBinary<A, X, Y> = dynamic Function(A, X, Y);
